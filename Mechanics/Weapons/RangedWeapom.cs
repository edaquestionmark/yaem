...
public class RangedWeapom : Weapon
{
    ...
    {
        projectile.Init(_projectilePool, FormArgs, _shootPosition.position);
        projectile.gameObject.SetActive(true);
        projectile.transform.rotation = Quaternion.Euler(0, 0, RandomSpread + _shootPosition.eulerAngles.z);
    }
