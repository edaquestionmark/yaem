...
public class Motor : UnitComponent
{
    ...
    {
        Cached.rotation = Quaternion.Lerp(Cached.rotation, Cached.LookAtDirection(dir), MaxRotationSpeed * Time.deltaTime);
    }
    ...
    private float maxSpeedChange => MaxAccelaration * Time.deltaTime;
}
